...
2.  **Streaming the Summary (`streamResponse`)**:
    -   Once the transcript is confirmed to be ready, this function makes a `POST` request to the `transcriptToNoteV2` streaming Lambda URL (`https://rmg4v7tjipa3lb5e5jkyjyc3ri0vdqmn.lambda-url.us-east-2.on.aws/`).
