...
- **Streaming Summary Generation**  
  ...
  - **Purpose:** Send `userId`, `timeStamp`, `accessToken`, and serialized `noteSettings` to the `transcriptToNoteV2` streaming Lambda (`https://rmg4v7tjipa3lb5e5jkyjyc3ri0vdqmn.lambda-url.us-east-2.on.aws/`) to generate the final note.
