...
- The demo variant omits pricing. Its hero pairs “Schedule a walkthrough” with a consent-aware, `landing_cta_click`-tracked “Try It Now” sign-up link to `/app?initialState=signUp`; later walkthrough actions continue to target the scheduler. Its overview video has only a heading, and the scheduler introduces itself as “LET'S CHAT” and “Have a Human explain ChiroNote,” then moves directly to its embed. The headline, clinical photo, and hero layout are preserved. Supporting copy addresses evening charting; demo-specific workflow, FAQ, and calendar copy explain getting started with Nikita over a 15-minute Zoom screen share, registration help, a mock appointment, note review/copying, and questions. The existing HIPAA FAQ explains service-provider BAAs without offering clinic-facing BAAs.
