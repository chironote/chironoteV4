...
| [Public Landing Pages](./components/landing-page.md) | Canonical, demo, and tutorial marketing structures; mobile-first presentation; demo scheduler/sign-up CTA split; HIPAA/BAA trust content; and analytics. |
