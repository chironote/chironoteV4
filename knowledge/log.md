...
- **Android API 36 readiness:** Raised compile and target SDK to 36 and upgraded the required build tooling to Android Gradle Plugin 8.9.1 and Gradle 8.11.1. No application behavior, version number, signing configuration, or Play Console state was changed by this source update.
