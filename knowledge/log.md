...
- **Clipboard workspace surface**: Restored the default workspace's quiet off-white canvas and a visible neutral inset around the white clipboard textarea. This removes the dark band exposed by rounded panel corners and preserves a distinct, touch-safe writing surface on Android without changing clipboard or recording behavior.
